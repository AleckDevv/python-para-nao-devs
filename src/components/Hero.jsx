    ...
    <section className="relative overflow-hidden bg-brand-blue text-white pt-24 pb-32">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <button className="w-full sm:w-auto px-8 py-4 bg-brand-yellow hover:bg-yellow-400 text-brand-blue font-bold rounded-xl text-lg transition-all duration-200 transform hover:-translate-y-1 hover:shadow-xl hover:shadow-brand-yellow/20 flex items-center justify-center gap-2 group">
